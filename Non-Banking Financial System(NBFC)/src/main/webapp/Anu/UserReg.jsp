...
<body>
  ...
  <form action="UserR" method="post" name="registration" class="registartion-form" onsubmit="return formValidation()">
    <table>
      <tr>
      ...
      <tr>
        <td colspan="2"><button class="submit" onclick="showAlert()">Register</button></td>
      </tr>
    </table>
  </form>
</div>
...
function showAlert() {
  var myText = "You Registered As Customer On AP Finance.";
  alert (myText);
}
</script>
</body>
