    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div class="col-lg-6 px-5 text-end">
                ...
                <small class="ms-4"><i class="fa fa-phone-alt text-primary me-2"></i>9890248063.</small>
            </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-light m-0">
                            <a href="Project" class="dropdown-item active">Projects</a>
                            <a href="Feature" class="dropdown-item">Features</a>
                            <a href="Team" class="dropdown-item">Team Member</a>
                            <a href="OurClients" class="dropdown-item">Testimonial</a>
                            <a href="Facilities" class="dropdown-item">404 Page</a>
                        </div>
                    </div>
          ...
          <a href="AllLogins" class="dropdown-item" style="background:blue;color:white;border-radius:7px;">login</a>
                </div>
            </div>
        </nav>
    </div>
                    ...
                    <div class="bg-white border rounded p-4 p-sm-5 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-center">
                                <button class="btn btn-primary w-100 py-3" type="submit">Message Now</button>
                            </div>
                        </div>
                        </form>
                    </div>
  ...
  <!-- Team Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-5">Meet Our Exclusive Team</h1>
            </div>
            <div class="row g-4">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-5">If You Have Any Query? Feel Free To Ask Our Agents Now</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <a href="Contact"><img class="img-fluid rounded" src="img/4.jpg" alt=""></a>
                        <div class="team-text">
                            <h4 class="mb-0">Omkar Kirve</h4>
                            <div class="team-social d-flex">
                                <a class="btn btn-square rounded-circle mx-1" href="Contact"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square rounded-circle mx-1" href="Contact"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square rounded-circle mx-1" href="Contact"><i
                                        class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <a href="Contact"><img class="img-fluid rounded" src="img/Pavan1.jpeg" alt=""></a>
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <a href="Contact"><img class="img-fluid rounded" src="img/3.jpg" alt=""></a>
                        <div class="team-text">
   ...
   <!-- Testimonial Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Satisfied Clients.</p>
                <h1 class="display-5 mb-5">Clients Feedback</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="testimonial-item">
                    ...
                    <h4>Chetan Sharma</h4>
                    <span>BE(Software Developer)</span>
                </div>
                <div class="testimonial-item">
                    <div class="testimonial-text border rounded p-4 pt-5 mb-5">
                        <div class="btn-square bg-white border rounded-circle">
